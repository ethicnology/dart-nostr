...
void main() {
  group('Event', () {
    test('Default constructor', () {
      ...
      const int createdAt = 1672175320;
      const int kind = 1;
  ...
  test('Constructor.serialize', () {
    ...
    final serializedWithSubscriptionId = json.encode([
      "EVENT",
      "subscription_id",
      {
        "id":
  ...
  test('Constructor.deserialize', () {
    ...
    final serializeWithoutSubscriptionId = json.encode([
      "EVENT",
      {
        ...
        "content":
            r"Block 773103 was just confirmed. The total value of all the non-coinbase outputs was 61,549,183,849 sats, or $14,025,828",
        "tags": [],
        "sig":
