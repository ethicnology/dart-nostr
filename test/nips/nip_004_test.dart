...
void main() {
  group('EncryptedDirectMessage', () {
    test('EncryptedDirectMessage.quick', () {
      ...
      const String plaintext = "vi veri universum vivus vici";
      final List<List<String>> tags = [
        ['p', alicePubkey]
      ];

      final EncryptedDirectMessage event =
    ...
    test('EncryptedDirectMessage Receive', () {
      ...
      final Message m = Message.deserialize(receivedEvent);
      final Event event = m.message;
      expect(event.id,
      ...
      final String content =
          (event as EncryptedDirectMessage).getPlaintext(bobPrivkey);
