...
void main() {
  group('EncryptedDirectMessage', () {
    test('EncryptedDirectMessage.newEvent', () {
      ...
      String alicePubKey = "0f76c800a7ea76b83a3ae87de94c6046b98311bda8885cedd8420885b50de181";
      ...
      List<List<String>> tags = [["p", alicePubKey]];

      EncryptedDirectMessage event = EncryptedDirectMessage.newEvent(
        alicePubKey,
        plaintext,
        bobPrivKey
      );
  ...
  test('Event receive', () {
    ...
    String tempPrivateKey = userPrivateKey;
    userPrivateKey = bobPrivKey; // from settings.dart
    ...
    expect(event.subscriptionId, "181555e0fec2139d27ac80a5a46801415394e61d67be7f626631760dc5997bc0");
